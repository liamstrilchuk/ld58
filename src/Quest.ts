...
const quests = [
	...
	new Quest(
		...
		"<inhales> oh, smells like spring! Since you've impressed me with your gardening skills so far, let's see if you can grow this one.",
		"expression-default",
		"expression-smile",
		{
			"lavender_flower": 1
	...
	new Quest(
		"The Maravine is unique in that it needs plenty of open space to grow; too crowded and it refuses!",
		"I've taught you everything I know, but here's a final challenge for you.",
		"expression-default",
		"expression-smile",
		{
			"orange_flower": 1
		...
		(game: Game) => {
			...
			game.encyclopedia.addEntry(
				new EncyclopediaEntry(
					"Starlume",
					"Amanita astralis",
					"Considered the magnum opus of gardening, the Starlume has only been grown a handful of times before. While there is little information on the species, an old scientific journal explains how to grow it: it must be within two tiles of two Maravines.",
					"mushroom_flower"
				)
			);
		},
	...
	new Quest(
		"The Starlume is the most complex plant to exist. I've never been able to make one, despite years of trying. Just for fun, let's see if you can do it!",
